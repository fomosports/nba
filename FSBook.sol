...
contract FSBook {
    ...
    // data
    uint256 public registrationFee_ = 100000000;            // price to register a name
    uint256 public affiliateFee_ = 2500000000;              // price to become an affiliate
        ...
        public
    {
        ...
        plyr_[1].addr = address(0x41c562d67f3f9b10078b24ff7e19a9dd2df45f4174);
        plyr_[1].name = "sportking";
        plyr_[1].hasAff = true;
        plyr_[1].names = 1;
        pIDxAddr_[address(0x41c562d67f3f9b10078b24ff7e19a9dd2df45f4174)] = 1;
    ...
    {
        // TODO : CHECK THE ADDRESS!!!
        require(msg.sender == address(0x41c562d67f3f9b10078b24ff7e19a9dd2df45f4174) ||
            ...
            msg.sender == address(0x41faa5a3215f731b9293127e8c58deb6a27670a4b9), "msg sender is not a dev");
        _;
    }
    ...
    function getPlayerIDFromName(uint256 _name)
        external
        view
        returns (uint256)
    {
        return (pIDxName_[bytes32(_name)]);
    }
